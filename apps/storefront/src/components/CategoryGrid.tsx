...
// Real categories, derived server-side from the live catalogue.
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group relative flex min-h-[19rem] flex-col justify-end overflow-hidden rounded-[1.75rem] p-6 ring-1 ring-ink/5"
                ...
                >
                  ...
                  <div className="relative">
                    <h3 className="font-display text-2xl capitalize text-ink">{name}</h3>
                    <p className="mt-1 text-[13px] text-ink/60">Shop the {name.toLowerCase()} edit</p>
                  </div>
